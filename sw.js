...
const CACHE = 'pr-p50-0.1.0';
const FILES = ['./', './index.html', './manifest.json', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './img/hero.png', './img/rusher.png'];   // Phase 5-0: スプライト画像もオフライン用に先読み
